          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div className="col-span-1">
              ...
              <div className="mt-3 grid space-y-3">
                <p>
                  <a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">
                    Pricing
                  </a>
                </p>
                <p>
            ...
            <div className="col-span-1">
              ...
              <div className="mt-3 grid space-y-3">
                ...
                <p>
                  ...
                  <span className="inline ms-1 text-xs bg-blue-700 text-white py-1 px-2 rounded-lg">We are hiring</span>
                </p>
                <p>
                  <a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">
                    Customers
